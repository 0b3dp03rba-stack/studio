...
export default function RiwayatPage() {
  ...
  // Query simpel tanpa orderBy untuk menghindari error Index/Permission
  ...
  // Sorting dilakukan di memori agar 100% aman dari error Firestore
  ...
  return (
    <div className="space-y-6 animate-in">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground text-sm font-medium uppercase tracking-widest opacity-70 text-[10px]">Lacak status setoran Gmail Anda.</p>
      </div>
              ...
              <CardContent className="p-5 flex items-center justify-between">
                ...
                <div className="flex items-center gap-5">
                  <div className="text-right">
                    <p className="text-xl font-black leading-none text-white">{batch.totalCount}</p>
      ...
      <Dialog open={!!selectedBatch} onOpenChange={() => setSelectedBatch(null)}>
        <DialogContent className="glass-card border-white/10 rounded-[2rem] bg-background">
          <DialogHeader>
